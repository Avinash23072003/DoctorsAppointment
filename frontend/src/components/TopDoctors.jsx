...
const TopDoctors = () => {
  ...
  doctors.slice(0, 10).map((item, index) => {
    // Strictly check for boolean value (avoid undefined or string)
      ...
      >
        ...
        <div className="p-4 space-y-2">
          <div className="flex items-center gap-2 text-sm">
            ...
            ></span>
            <span className={isAvailable ? "text-green-500" : "text-gray-600"}>
  ...
  <p className="text-center text-gray-500 mt-10">Loading doctors...</p>
      ...
      {/* More Button */}
      <button
        className="mt-6 bg-blue-500 text-white px-6 py-2 rounded-lg hover:bg-blue-600 transition duration-200 cursor-pointer"
        onClick={() => {
          navigate("/doctors");
          scrollTo(0, 0);
        }}
